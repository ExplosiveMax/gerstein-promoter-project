...
plt.savefig("results/plots/plot_window_size.png", dpi=150, bbox_inches="tight")
print("Saved results/plots/plot_window_size.png")
...
plt.ylim(0.5, 1.05)
plt.legend()
plt.savefig("results/plots/plot_offset.png", dpi=150, bbox_inches="tight")
print("Saved results/plots/plot_offset.png")