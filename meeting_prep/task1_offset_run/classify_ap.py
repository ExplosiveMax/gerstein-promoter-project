...
parser.add_argument("--promoters", default="promoters.fasta")
parser.add_argument("--randoms", default="random_sequences.fa")
...
promoters = load_fasta(args.promoters)
randoms = load_fasta(args.randoms)
...
print(f"FINAL_RESULT seed={seed} auc={auc:.4f} auprc={auprc:.4f}")
